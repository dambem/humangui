...
public Timetable() throws Exception {
	...
	createTimetable(contentPane1);
	addAppForm(contentPane1);
...
public static void createTimetable(Container contentPane1) throws Exception{
	...
	List<String> day1apps = SqlCreation.getAppsOnDate(today);
	addApps(day1apps, c, contentPane1, contentPane, 1, today);
			
	List<String> day2apps = SqlCreation.getAppsOnDate(tomorrow);
	addApps(day2apps, c, contentPane1, contentPane, 2, tomorrow);
	
	List<String> day3apps = SqlCreation.getAppsOnDate(day3);
	addApps(day3apps, c, contentPane1, contentPane, 3, day3);
	
	List<String> day4apps = SqlCreation.getAppsOnDate(day4);
	addApps(day4apps, c, contentPane1, contentPane, 4, day4);
	
	List<String> day5apps = SqlCreation.getAppsOnDate(day5);
	addApps(day5apps, c, contentPane1, contentPane, 5, day5);
	
	List<String> day6apps = SqlCreation.getAppsOnDate(day6);
	addApps(day6apps, c, contentPane1, contentPane, 6, day6);
	
	List<String> day7apps = SqlCreation.getAppsOnDate(day7);
	addApps(day7apps, c, contentPane1, contentPane, 7, day7);
...
public static void addAppForm(Container contentPane1) throws Exception {
	...
	addApp.addMouseListener(new MouseAdapter() {
		...
		public void mouseClicked(MouseEvent e) {
			...
			contentPane1.add(appointmentForm, BorderLayout.CENTER);
			contentPane1.revalidate();
		}
	});
	
	contentPane1.add(addApp, BorderLayout.SOUTH);
}
...
static String getDayOfMonthSuffix(Date date) {
	...
	public static void addApps(List<String> dayApps, GridBagConstraints c, Container contentPane1, JPanel contentPane, int day, Date appDate) throws Exception {
